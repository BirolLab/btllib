...
main()
{
...

  {
    ...
    btllib::BsHashDirectional bshash_vector[] = {
      btllib::BsHashDirectional(
        kmer1, bshash.get_hash_num(), kmer1.size(), "CT"),
      btllib::BsHashDirectional(
        kmer2, bshash.get_hash_num(), kmer2.size(), "CT"),
      btllib::BsHashDirectional(
        kmer3, bshash.get_hash_num(), kmer3.size(), "CT")
    };
...

  {
    ...
    btllib::BsHashDirectional bshash(seq, 3, seq.size() - 2, "GA");
    /* 19-mers of kmer*/
    std::string kmer1 = seq.substr(0, 22);
    std::string kmer2 = seq.substr(1, 22);
    std::string kmer3 = seq.substr(2, 22);
    ...
    btllib::BsHashDirectional bshash_vector[] = {
      btllib::BsHashDirectional(
        kmer1, bshash.get_hash_num(), kmer1.size(), "GA"),
      btllib::BsHashDirectional(
        kmer2, bshash.get_hash_num(), kmer2.size(), "GA"),
      btllib::BsHashDirectional(
        kmer3, bshash.get_hash_num(), kmer3.size(), "GA")
    };
...

  {
    ...
    btllib::BsHashDirectional bshash_f(seq_f, h, seq_f.size(), "GA");
    btllib::BsHashDirectional bshash_r(seq_r, h, seq_r.size(), "CT");
...

  {
    ...
    btllib::BsHashDirectional bshash(seq, 3, seq.size(), "GA");
    btllib::BsHashDirectional bshash_subbed(sub, 3, sub.size(), "GA");
