...
constexpr uint64_t CC_DIMER_TAB[45] = {
    0,      // unused (index 0–10 not used)
    /* 11–14: A-based dimers */
    [11] = 0x1bc5d5aba6ea6e02ULL, // "AA"
    [12] = 0x8f15314b06b5ed9cULL, // "AC"
    [13] = 0x1bc5d5aba6ea6e02ULL, // "AG"
    [14] = 0x8f15314b06b5ed9cULL, // "AT"

    /* 21–24: C-based dimers */
    [21] = 0x44fec7e4a74bce00ULL, // "CA"
    [22] = 0x77c24a36c934fdc1ULL, // "CC"
    [23] = 0x44fec7e4a74bce00ULL, // "CG"
    [24] = 0x77c24a36c934fdc1ULL, // "CT"

    /* 31–34: G-based dimers */
    [31] = 0x1bc5d5aba6ea6e02ULL, // "GA"
    [32] = 0x8f15314b06b5ed9cULL, // "GC"
    [33] = 0x1bc5d5aba6ea6e02ULL, // "GG"
    [34] = 0x8f15314b06b5ed9cULL, // "GT"

    /* 41–44: T-based dimers */
    [41] = 0x44fec7e4a74bce00ULL, // "TA"
    [42] = 0x77c24a36c934fdc1ULL, // "TC"
    [43] = 0x44fec7e4a74bce00ULL, // "TG"
    [44] = 0x77c24a36c934fdc1ULL  // "TT"
};
constexpr uint64_t CC_DIMER_TAB[45] = {
    0,      // unused (index 0–10 not used)
    /* 11–14: A-based dimers */
    [11] = 0x54f8849020caa27fULL, // "AA"
    [12] = 0xab9766c9a48a5d70ULL, // "AC"
    [13] = 0x7f01ee303c53b1bcULL, // "AG"
    [14] = 0xab9766c9a48a5d70ULL, // "AT"

    /* 21–24: C-based dimers */
    [21] = 0xd22f7891d06d2f5aULL, // "CA"
    [22] = 0xf1bd2f3bbfb10000ULL, // "CC"
    [23] = 0xd22f7891d06d2f5aULL, // "CG"
    [24] = 0xf1bd2f3bbfb10000ULL, // "CT"

    /* 31–34: G-based dimers */
    [31] = 0x54f8849020caa27fULL, // "GA"
    [32] = 0xab9766c9a48a5d70ULL, // "GC"
    [33] = 0x7f01ee303c53b1bcULL, // "GG"
    [34] = 0xab9766c9a48a5d70ULL, // "GT"

    /* 41–44: T-based dimers */
    [41] = 0x414ce1fc78d4d36fULL, // "TA"
    [42] = 0xff3adb2d91cd4803ULL, // "TC"
    [43] = 0xd22f7891d06d2f5aULL, // "TG"
    [44] = 0xff3adb2d91cd4803ULL  // "TT"
};
constexpr uint64_t CA_DIMER_TAB[45] = {
    0,      // unused (index 0–10 not used)
    /* 11–14: A-based dimers */
    [11] = 0x7e4a36919c5032afULL, // "AA"
    [12] = 0x95b4b90696718a9fULL, // "AC"
    [13] = 0xf482881f5f3610bfULL, // "AG"
    [14] = 0x95b4b90696718a9fULL, // "AT"

    /* 21–24: C-based dimers */
    [21] = 0xe12f0e8e678e5d30ULL, // "CA"
    [22] = 0x9ff825331cf8a361ULL, // "CC"
    [23] = 0xf248b960f9159cecULL, // "CG"
    [24] = 0x9ff825331cf8a361ULL, // "CT"

    /* 31–34: G-based dimers */
    [31] = 0x7e4a36919c5032afULL, // "GA"
    [32] = 0x95b4b90696718a9fULL, // "GC"
    [33] = 0xf482881f5f3610bfULL, // "GG"
    [34] = 0x95b4b90696718a9fULL, // "GT"

    /* 41–44: T-based dimers */
    [41] = 0xe12f0e8e678e5d30ULL, // "TA"
    [42] = 0x00e055ee083cfcffULL, // "TC"
    [43] = 0xe12f0e8e678e5d30ULL, // "TG"
    [44] = 0x00e055ee083cfcffULL  // "TT"
};
constexpr uint64_t CT_DIMER_TAB[45] = {
    0,      // unused (index 0–10 not used)
    /* 11–14: A-based dimers */
    [11] = 0x9a533a6a5e7b14e2ULL, // "AA"
    [12] = 0x9a533a6a5e7b14e2ULL, // "AC"
    [13] = 0x9a533a6a5e7b14e2ULL, // "AG"
    [14] = 0x897da34f6b464570ULL, // "AT"

    /* 21–24: C-based dimers */
    [21] = 0xeeaf42d6e10d9ac0ULL, // "CA"
    [22] = 0x049bab70128da11fULL, // "CC"
    [23] = 0x68c7d4adebfb5001ULL, // "CG"
    [24] = 0x049bab70128da11fULL, // "CT"

    /* 31–34: G-based dimers */
    [31] = 0x9a533a6a5e7b14e2ULL, // "GA"
    [32] = 0x9a533a6a5e7b14e2ULL, // "GC"
    [33] = 0x9a533a6a5e7b14e2ULL, // "GG"
    [34] = 0x897da34f6b464570ULL, // "GT"

    /* 41–44: T-based dimers */
    [41] = 0x0f1bfc76a0e3e700ULL, // "TA"
    [42] = 0x049bab70128da11fULL, // "TC"
    [43] = 0x282450c57fae339fULL, // "TG"
    [44] = 0x049bab70128da11fULL  // "TT"
};

// Generic dimer-based rolling hash
inline std::pair<uint64_t, uint64_t>
base_forward_bs_hash(const char* seq, unsigned len, unsigned k, const uint64_t* DIMER_TAB)
{
    ...
    for (unsigned i = 0; i < k - 1; i += 2) {
        h0 = srol(h0, 1);
        const uint8_t a = CONVERT_TAB_SIMPLE[(unsigned char)seq[i]];
        const uint8_t b = CONVERT_TAB_SIMPLE[(unsigned char)seq[i + 1]];
...
inline uint64_t
srol_bs_table(uint8_t out_idx, unsigned d, const uint64_t* const* 33R_TAB, const uint64_t* const* 31L_TAB)
{
  return (31L_TAB[out_idx][d < 31 ? d : d % 31] | /* NOLINT */
          33R_TAB[out_idx][d < 33 ? d : d % 33]); /* NOLINT */
}
...
next_forward_bs_hash(uint64_t fh_val,
                        ...
                        const uint64_t* const* 33R_TAB,
                        const uint64_t* const* 31L_TAB)
{
  ...
  h_val ^= srol_bs_table(out_idx, k, 33R_TAB, 31L_TAB);
                        ...
                        const uint64_t* const* 31L_TAB)
{
  ...
  uint64_t h_val = fh_val ^ srol_bs_table(in_idx, k, 33R_TAB, 31L_TAB);
...
inline std::pair<uint64_t, uint64_t>
base_reverse_bs_hash(const char* seq, unsigned len, unsigned k, const uint64_t* const* DIMER_TAB)
{
    if (len < k)
        return {0, 0};
...
next_reverse_bs_hash(uint64_t rh_val,
                  unsigned k,
                        ...
                        const uint64_t* const* 31L_TAB)
{
  uint8_t out_idx = 10 * CONVERT_TAB_RC[char_out1] + CONVERT_TAB_RC[char_out2];
  uint8_t in_idx  = 10 * CONVERT_TAB_RC[char_in1]  + CONVERT_TAB_RC[char_in2];
  uint64_t h_val = rh_val ^ srol_bs_table(in_idx, k, 33R_TAB, 31L_TAB);
  h_val ^= DIMER_TAB[out_idx];
  h_val = srol(h_val);
  return h_val;
}
